...
logger = logging.getLogger("hermes.connectors.slack_connector")


class SlackConnector(AuraTool):
    """Read/send Slack messages — Phase 2 stub."""

    tool_name = "slack"
    tool_version = "0.1.0"
    tool_description = "Read/send Slack messages (Phase 2 — not yet implemented)"
    phase = 2
    status = "placeholder"
