...
logger = logging.getLogger("hermes.connectors.gmail_connector")


class GmailConnector(AuraTool):
    """Read/send Gmail messages — Phase 2 stub."""

    tool_name = "gmail"
    tool_version = "0.1.0"
    tool_description = "Read/send Gmail messages (Phase 2 — not yet implemented)"
    phase = 2
    status = "placeholder"
